        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0 mt-2">
                    <li class="nav-item">
                        <a class="btn btn-outline-info px-4 py-1 <?php echo ($pg == "inicio") ? "active" : "" ?>" style="color: black;" href="datos.php">LISTA DE PERSONAS</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-outline-info px-4 py-1 <?php echo ($pg == "sobre-mi") ? "active" : "" ?>" style="color: black;" href="index.php">SECRETO</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-outline-info px-4 py-1 <?php echo ($pg == "proyectos")? "active" : "" ?>" style="color: black;" href="tarjeta.php">ARMA TARJETA</a>
                    </li>
                    <li class="nav-item">
